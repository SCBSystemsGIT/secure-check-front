...
const submit = async () => {
  await createQR(email.value, type.value, date.value);
};
        ...
        <div class="col col-12 col-md-12 col-sm-12">
          ...
          <div class="popup-logo">
            ...
            <form @submit.prevent="submit" class="mt-5">
              <div>
                <label class="my-2" for="contact">Email</label><br />
                <input
                  type="text"
                  id="contact"
                  v-model="email"
              ...
              <div>
                <label class="my-2" for="type_qr">Type de QR</label><br />
                <select
                  v-model="type"
                  id="type_qr"
                  name="type_qr"
                ...
                >
                  ...
                  <option value="temp">Temporaire</option></select
                ><br />
              </div>


              <div v-if="type == 'temp'">
                <label class="my-2" for="contact">Date</label><br />
                <input
                  type="date"
                  id="contact"
                  v-model="date"
