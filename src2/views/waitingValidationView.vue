    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        <div class="col col-12 col-md-12 col-sm-12">
          ...
          <button class="back mb-3" @click="goToList()">Retour</button>
          ...
          <div v-if="!isSuccess">
            <h3 class="text-center py-3">En attente de la confirmation de l'hôte ...</h3>

            <div class="request-btn" @click.prevent="submitForm(1)" v-if="!isLoading" role="button">
              <a>Valider </a>
            </div>
            ...
            <div class="request-btn-cannel" @click.prevent="submitForm(0)" role="button">
              <a>Annuler </a>
            </div>
          </div>
        </div>
