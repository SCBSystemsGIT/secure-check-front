      ...
      <table v-if="companyList.length" class="mdc-data-table__table">
		<thead>
			<tr class="mdc-data-table__header-row">
				...
				<th class="mdc-data-table__header-cell" role="columnheader" aria-sort="none"><div class="mdc-data-table__header-cell-wrapper">Entreprise name</div></th>
				...
				<th class="mdc-data-table__header-cell" role="columnheader" aria-sort="none"><div class="mdc-data-table__header-cell-wrapper">Slug</div></th>
				<th class="mdc-data-table__header-cell" role="columnheader" aria-sort="none"><div class="mdc-data-table__header-cell-wrapper">Image</div></th>
			</tr>
		</thead>
        <tbody>
